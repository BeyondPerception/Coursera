...
public class VMTranslator {
	...
	public static void main(String... args) throws Exception {
		...
		if (fileIn.isFile()) {
			...
			out = new PrintWriter(new FileWriter(new File(
					System.getProperty("user.dir") + File.separator + fileIn.getName()
							+ File.separator + fileIn.getName() + ".asm")));
			System.out.println(System.getProperty("user.dir") + File.separator
					+ fileIn.getName() + File.separator + fileIn.getName() + ".asm");

			out.println("@256\n" + "D=A\n" + "@SP\n" + "M=D\n");
			String newLabel = "RETURN_LABEL" + (labalcnt++);
